    ...
    education: [
        {
            ...
            title: "Metriculation",
            description: "I have completed my metriculation in 2016 from Govt. High School.",
            institute: "Govtvernment High School of Khan Khasa",
        },{
            id: 2,
            date: "2017 - 2021",
            title: "Deploma of Associate Engineering (DAE) in Electrical Technology",
            description: "I have completed my DAE in Electrical Technology with 70% marks from Abdul Wahab College of Technology.",
            institute: "Abdul Wahab College of Technology and Sciences Narowal",
        },{
            id: 3,
            date: "March 2022 - Present",
            title: "Bachelor of Science in Computer Science",
            description: "I am currently studying in BS Computer Science from Virtual University of Pakistan",
            institute: "Virtual University of Pakistan Narowal Campus",
        },
    ],
    experience: [
        {
            ...
            date: "Present",
            title: "Tailwind CSS",
            description: "I am currently working on Tailwind CSS and I have completed many projects using Tailwind CSS.",
            compnay: "-",
        },{
            id: 2,
            date: "Present",
            title: "React JS",
            description: "I am currently working on React JS and I have completed many projects using React JS.",
            compnay: "-",
        },{
            id: 3,
            date: "Present",
            title: "RTK Query",
            description: "I am currently working on RTK Query and I have completed many projects using RTK Query.",
            compnay: "-",
        },
    ],
}
...
export const contacts = {
    contact : {
        ...
        address: "Khan Khasa, Narowal, Punjab, Pakistan",
    },
    social: {
